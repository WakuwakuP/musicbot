...
const PORT_AUDIO_DEVICE_ID = process.env.PORT_AUDIO_DEVICE_ID;
...
const PORT_AUDIO_DEVICE_ID_DEV = process.env.PORT_AUDIO_DEVICE_ID_DEV;
...
module.exports = {
  apps: [{
    ...
    env_production: {
      ...
      PORT_AUDIO_DEVICE_ID: PORT_AUDIO_DEVICE_ID
    },
    env_development: {
      ...
      PORT_AUDIO_DEVICE_ID: PORT_AUDIO_DEVICE_ID_DEV
    }
  }]
}
